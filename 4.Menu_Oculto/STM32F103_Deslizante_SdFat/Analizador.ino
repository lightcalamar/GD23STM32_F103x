...
//GD.Tag(200);  GD.cmd_button(5, 50, 120, 35, 26, 0,  " ");        GD.Tag(255);
   ...
   if (GD.inputs.tag==201)
     {
      CargaAssetNuevo=1; Xbase=0; Avance=1;  Velocidad=5; espera();  MP();  //evita la recarga de asset siempre y cuando no se haya cargado otro en este menu 
     }
